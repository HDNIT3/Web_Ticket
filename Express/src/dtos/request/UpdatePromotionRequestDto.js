...
class UpdatePromotionRequestDto {
    constructor(body = {}) {
        ...
        this.discountType = typeof body.discountType === 'string' ? body.discountType.trim().toUpperCase() : undefined;
        ...
        this.code = typeof body.code === 'string' ? body.code.trim().toUpperCase() : undefined;
    ...
    validate() {
        ...
        if (typeof this.name !== 'undefined') {
            if (!this.name) {
                errors.push({ field: 'name', message: 'Tên khuyến mãi không được để trống.' });
        ...
        if (typeof this.discountType !== 'undefined' && !VALID_DISCOUNT_TYPES.includes(this.discountType)) {
            errors.push({ field: 'discountType', message: 'discountType phải là PERCENT hoặc AMOUNT.' });
        }

        if (typeof this.discountValue !== 'undefined') {
            if (!Number.isFinite(this.discountValue)) {
        ...
        if (typeof this.startDate !== 'undefined' && Number.isNaN(this.startDate.getTime())) {
            errors.push({ field: 'startDate', message: 'Ngày bắt đầu không hợp lệ.' });
        }

        if (typeof this.endDate !== 'undefined' && Number.isNaN(this.endDate.getTime())) {
        ...
        if (typeof this.code !== 'undefined') {
            if (!this.code) {
                errors.push({ field: 'code', message: 'Mã khuyến mãi không được để trống.' });
